         ...
         <div class="container mt-5">
            ...
            <div class="row">
                ...
                <!-- Formulir Create -->
                    <div class="card">
                        <div class="card-body">
                              <form action="{{ route('admin-sekolah.update', "$user->id") }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('sekolah_id') is-invalid @enderror" id="sekolah_id" name="sekolah_id" required>
                                        ...
                                        @foreach ($schools as $sekolah)
                                            <option value="{{$sekolah->id}}" {{ old('sekolah_id', $user->sekolah_id) == $sekolah->id ? 'selected' : '' }}>{{$sekolah->name}}</option>
